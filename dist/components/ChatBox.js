...
var _FirstMessage = _interopRequireDefault(require("../../src/components/FirstMessage"));

var _OpenView = _interopRequireDefault(require("../../src/components/OpenView"));
...
const ClosedSvg = (_ref2) => {
  let { onClick, primaryColor } = _ref2;
  return /*#__PURE__*/ _react.default.createElement(
    Button,
    {
      onClick: onClick,
...
const ChatBox = (props) => {
  ...
  const handleAddMessage = async (text) => {
    ...
    const resp = await _axios.default.post(
      url,
      {
        question: text,
        messages: _messages,
  ...
  if (authed) {
    return /*#__PURE__*/ _react.default.createElement(
      ...
      null,
      showFirst &&
        /*#__PURE__*/ _react.default.createElement(_FirstMessage.default, {
          chatOpen: open,
        }),
      open &&
        /*#__PURE__*/ _react.default.createElement(_OpenView.default, {
      ...
      open
        ? /*#__PURE__*/ _react.default.createElement(OpenSvg, {
            primaryColor: primaryColor,
